<template>
  <div class="h-full w-full flex flex-col overflow-hidden">
    ...
    <div class="flex-1 overflow-auto p-4 space-y-4">
      <div class="grid grid-cols-[480px_1fr] gap-4">
        <!-- 合同申请 -->
        <div class="border rounded-lg p-4 relative min-w-0">
          <div class="absolute -top-3 left-4 px-2 bg-white text-base font-bold">合同申请</div>
          <div class="flex items-center gap-4 mt-2">
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">合同号</Label>
              <Input v-model="requestForm.orderNo" class="w-36" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">项目号</Label>
        ...
        <!-- 合同查询 -->
        <div class="border rounded-lg p-4 relative min-w-0">
          <div class="absolute -top-3 left-4 px-2 bg-white text-base font-bold">合同查询</div>
          <div class="flex items-center gap-4 mt-2 flex-wrap">
            ...
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">查询日期范围</Label>
              <Input v-model="queryForm.dateFrom" type="date" class="w-40" />
            </div>
            <Label class="whitespace-nowrap text-sm font-bold">至</Label>
      ...
      <!-- 合同明细 -->
      <div class="border rounded-lg mt-8 p-4 relative">
        ...
        <div class="space-y-3 mt-2">
          ...
          <div class="flex items-center gap-4 flex-wrap">
            ...
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">轧批号</Label>
              <Input v-model="formData.roll_no" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">外径</Label>
              <Input v-model="formData.diameter" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">壁厚</Label>
              <Input v-model="formData.wall_thickness" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">原合同号</Label>
          ...
          <div class="grid grid-cols-12 gap-3">
            <div class="col-span-2 flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">品名细分类代码</Label>
              <Input v-model="formData.prod_code" class="flex-1" />
            </div>
            <div class="col-span-3 flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">品名细分类</Label>
            ...
            <div class="col-span-2 flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">热处理方式代码</Label>
              <Input v-model="formData.heat_treat_code" class="flex-1" />
            </div>
            <div class="col-span-5 flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">热处理方式正文</Label>
          ...
          <div class="grid grid-cols-12 gap-3">
            <div class="col-span-2 flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">标准钢级代码</Label>
              <Input v-model="formData.std_sg_code" class="flex-1" />
            </div>
            <div class="col-span-10 flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">标准正文</Label>
          ...
          <div class="grid grid-cols-12 gap-3">
            <div class="col-span-5 flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">钢级正文</Label>
              <Input v-model="formData.sg_text" class="flex-1" />
            </div>
            <div class="col-span-2 flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">材质号</Label>
              <Input v-model="formData.mat_no" class="flex-1" />
            </div>
            <div class="col-span-5 flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">材质正文</Label>
          ...
          <div class="grid grid-cols-6 gap-3">
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">螺纹类型代码</Label>
              <Input v-model="formData.end_type_code" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">螺纹类型符号</Label>
              <Input v-model="formData.end_type_sign" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">管端类型代码</Label>
              <Input v-model="formData.thread_type_code" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">管端类型符号</Label>
              <Input v-model="formData.thread_type_sign" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">接箍类型代码</Label>
              <Input v-model="formData.coupling_type_code" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">接箍类型符号</Label>
          ...
          <div class="grid grid-cols-6 gap-3">
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">螺纹表面处理方式代码</Label>
              <Input v-model="formData.thread_face_treat_mode_code" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">螺纹表面处理方式</Label>
              <Input v-model="formData.thread_face_treat_mode" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">订货长度起</Label>
              <Input v-model="formData.length_from" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">订货长度止</Label>
              <Input v-model="formData.length_to" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">订货计量单位代码</Label>
              <Input v-model="formData.order_unit_code" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">订货计量单位</Label>
          ...
          <div class="grid grid-cols-6 gap-3">
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">订货数量</Label>
              <Input v-model="formData.order_qty" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">订货根数</Label>
              <Input v-model="formData.order_tube" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">订货重量</Label>
              <Input v-model="formData.order_weight" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">定尺订货重量</Label>
              <Input v-model="formData.fixed_order_weight" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">非定尺订货重量</Label>
              <Input v-model="formData.unfixed_order_weight" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">提货公差单位代码</Label>
          ...
          <div class="flex items-center gap-3 flex-wrap">
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">提货公差单位</Label>
              <Input v-model="formData.delivery_tolerance_unit" class="w-16" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">提货公差起-至</Label>
              <Input v-model="formData.delivery_tolerance_from" class="w-16" />
              <span class="font-bold">-</span>
              <Input v-model="formData.delivery_tolerance_to" class="w-16" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">短尺率</Label>
              <Input v-model="formData.short_rate" class="w-12" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">短尺长度起-至</Label>
              <Input v-model="formData.short_from" class="w-20" />
              <span class="font-bold">-</span>
              <Input v-model="formData.short_to" class="w-20" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">最大单捆重量</Label>
              <Input v-model="formData.single_bundle_weight_max" class="w-20" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">最大单捆根数</Label>
              <Input v-model="formData.single_bundle_tube_max" class="w-14" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">涂油代码</Label>
              <Input v-model="formData.oil_code" class="w-40" />
            </div>
            <div class="flex flex-1 items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">涂油正文</Label>
          ...
          <!-- 第9行：压印要求 -->
          <div class="flex items-center gap-2">
            <Label class="whitespace-nowrap text-sm font-bold">压印要求</Label>
            <Input v-model="formData.stamp_req" class="flex-1" />
          </div>

          <!-- 第10行：喷印要求 -->
          <div class="flex items-center gap-2">
            <Label class="whitespace-nowrap text-sm font-bold">喷印要求</Label>
          ...
          <div class="grid grid-cols-2 gap-3">
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">标签要求1</Label>
              <Input v-model="formData.label_req_1" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">标签要求2</Label>
          ...
          <div class="grid grid-cols-2 gap-3">
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">标签要求3</Label>
              <Input v-model="formData.label_req_3" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">标签要求4</Label>
          ...
          <div class="grid grid-cols-2 gap-3">
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">标签要求5</Label>
              <Input v-model="formData.label_req_5" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">标签要求6</Label>
          ...
          <div class="grid grid-cols-2 gap-3">
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">标签要求7</Label>
              <Input v-model="formData.label_req_7" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">标签要求8</Label>
          ...
          <div class="grid grid-cols-2 gap-3">
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">质量特殊要求</Label>
              <Input v-model="formData.qual_special_req" class="flex-1" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">生产特殊要求</Label>
              <Input v-model="formData.produce_special_req" class="flex-1" />
            </div>
          </div>

          <!-- 第16行：生产特殊要求、色环、色环位置、标准水压压力(MPA/PSI)、最小稳压时间、退火标志、米重、EV值、名义重量 -->
          <div class="flex items-center gap-4 flex-wrap">
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">色环</Label>
              <Input v-model="formData.color_circle" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">色环位置</Label>
              <Input v-model="formData.color_circle_pos" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">标准水压压力(MPA)</Label>
              <Input v-model="formData.std_pressure_mpa" class="w-16" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">标准水压压力(PSI)</Label>
              <Input v-model="formData.std_pressure_psi" class="w-20" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">最小稳压时间</Label>
              <Input v-model="formData.stabilivolt_time_min" class="w-16" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">退火标志</Label>
              <Input v-model="formData.anneal_flag" class="w-20" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">米重</Label>
              <Input v-model="formData.weight_per_meter" class="w-20" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">EW值</Label>
              <Input v-model="formData.weight_ew" class="w-20" />
            </div>
            <div class="flex items-center gap-2">
              <Label class="whitespace-nowrap text-sm font-bold">名义重量</Label>

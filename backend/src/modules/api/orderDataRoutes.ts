    ...
    try {
      await prisma.$executeRaw`
        INSERT INTO api_order_data_t (
          ...
          label_req_1, label_req_2, label_req_3, label_req_4,
          label_req_5, label_req_6, label_req_7, label_req_8,
          ...
          ${data.label_req_1}, ${data.label_req_2},
          ${data.label_req_3}, ${data.label_req_4},
          ${data.label_req_5}, ${data.label_req_6},
          ${data.label_req_7}, ${data.label_req_8},
    ...
    try {
      const affected = await prisma.$executeRaw`
        UPDATE api_order_data_t SET
          ...
          label_req_1 = ${data.label_req_1},
          label_req_2 = ${data.label_req_2},
          label_req_3 = ${data.label_req_3},
          label_req_4 = ${data.label_req_4},
          label_req_5 = ${data.label_req_5},
          label_req_6 = ${data.label_req_6},
          label_req_7 = ${data.label_req_7},
          label_req_8 = ${data.label_req_8},
          ...
          stencil_req_manual = ${data.stencil_req_manual},
          label_req_1_manual = ${data.label_req_1_manual},
          label_req_2_manual = ${data.label_req_2_manual},
          label_req_3_manual = ${data.label_req_3_manual},
          label_req_4_manual = ${data.label_req_4_manual},
          label_req_5_manual = ${data.label_req_5_manual},
          label_req_6_manual = ${data.label_req_6_manual},
          label_req_7_manual = ${data.label_req_7_manual},
          label_req_8_manual = ${data.label_req_8_manual},
          label_length_type = ${data.label_length_type}::int,
          label_weight_type = ${data.label_weight_type}::int,
          label_type = ${data.label_type}::int,
          stamp_req_1_manual = ${data.stamp_req_1_manual},
          stamp_req_2_manual = ${data.stamp_req_2_manual},
          stamp_req_3_manual = ${data.stamp_req_3_manual},
          stamp_req_4_manual = ${data.stamp_req_4_manual},
          stamp_req_5_manual = ${data.stamp_req_5_manual},
          stamp_req_6_manual = ${data.stamp_req_6_manual},
